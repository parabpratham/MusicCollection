...
public class UserDTO extends BaseDTO
{
	...
	private UserPlayListDTO	playListDTO;

	public UserDTO()
	{
		playListDTO = new UserPlayListDTO();
		playListDTO.setUserDTO(this);
	}
	...
	public UserPlayListDTO getPlayListDTO()
	{
		return playListDTO;
	}

	public void setPlayListDTO(UserPlayListDTO playListDTO)
	{
